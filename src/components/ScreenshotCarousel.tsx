...
const ScreenshotCarousel = () => {
  ...
  return (
    <section id="screenshots" className="section-padding bg-gradient-to-b from-gray-50 to-white relative">
      <div className="container mx-auto max-w-6xl px-4 sm:px-8 py-12">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gradient mb-3">Experience CoinApp</h2>
        ...
        <div className="relative">
          ...
          <Carousel
            opts={{ loop: true, align: "center", startIndex: activeIndex }}
            className="w-full"
          >
            <CarouselContent className="transition duration-500 ease-in-out">
              {screenshots.map((shot, index) => (
                ...
                >
                  <div
                    className={cn(
                      "rounded-2xl bg-white border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-500 h-full flex flex-col items-center justify-between p-6",
                      index === activeIndex ? "scale-105" : "scale-95 opacity-80"
                    )}
                  >
                    <Badge className="mb-4 bg-coin-gold text-white px-3 py-1 rounded-full">
                      {shot.feature}
                    </Badge>

                    <div className="relative w-[280px] h-[570px] rounded-[2.5rem] border-[14px] border-gray-900 bg-gray-800 shadow-lg overflow-hidden">
                    ...
                    <h3 className="mt-6 text-lg font-semibold text-coin-navy">
                      {shot.caption}
                    </h3>
                  </div>
                </CarouselItem>
            ...
            <CarouselPrevious className="hidden sm:flex -left-6 shadow hover:bg-coin-navy hover:text-white" />
            <CarouselNext className="hidden sm:flex -right-6 shadow hover:bg-coin-navy hover:text-white" />
          </Carousel>
