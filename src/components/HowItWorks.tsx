...
const StepItem = ({
  ...
  return (
    <div className="flex flex-col items-center text-center relative">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 w-full relative z-10 hover:shadow-xl transition-shadow duration-300 group">
        ...
        <h3 className="text-xl font-semibold mb-2 group-hover:text-coin-gold transition-colors duration-300 text-gray-900 dark:text-white">
          {title}
        </h3>
...
const HowItWorks = () => {
  const steps = [
    {
      icon: <Camera className="h-6 w-6 dark:text-coin-gold" />,
      title: "Take a Photo",
      description:
        "Snap a clear photo of both sides of your coin using the CoinApp camera.",
      imageSrc: "/identification.svg",
    },
    {
      icon: <Star className="h-6 w-6 dark:text-coin-gold" />,
      title: "Get Results",
      description:
        "Receive instant identification, grading, and valuation details.",
      imageSrc: "/ss1.svg",
    },
    {
      icon: <Database className="h-6 w-6 dark:text-coin-gold" />,
      title: "Manage Collection",
      description:
        "Add to your digital collection with all details automatically saved.",
    ...
    >
      ...
      <div className="container mx-auto container-padding relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gradient dark:text-white">
            How It Works
          </h2>
        ...
        <div className="mt-16 text-center">
          <div className="inline-block bg-gradient-to-r from-coin-gold/10 to-coin-navy/10 px-8 py-6 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300">
            <p className="text-coin-navy dark:text-coin-gold font-medium text-lg">
              "CoinApp has revolutionized my collecting process. What used to
              take hours now takes seconds."
            </p>
            <p className="mt-2 text-gray-600 dark:text-gray-300">
              — James W., Professional Collector
            </p>
          </div>
        </div>
      </div>
